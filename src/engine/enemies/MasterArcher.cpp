...
// Init
MasterArcher::MasterArcher(std::shared_ptr<Player> player): BaseEnemy("MasterArcher" + std::to_string(master_archer_count), "./resources/assets/Display_Objects/MasterArcher.png", "", player){
    this->state = 0;
