...
void Editor::handleEvent(Event* e) {
    if (e->getType() == MouseDownEvent::MOUSE_DOWN_EVENT) {
        ...
        for (DisplayObject* object : this->selected) {
            ...
            this->displacementX += event->xrel;
            this->displacementY += event->yrel;
            ...
            object->position.x += static_cast<int>(trunc(this->displacementX / zoom));
            object->position.y += static_cast<int>(trunc(this->displacementY / zoom));
            ...
            this->displacementX = fmod(this->displacementX, zoom);
            this->displacementY = fmod(this->displacementY, zoom);
        }
